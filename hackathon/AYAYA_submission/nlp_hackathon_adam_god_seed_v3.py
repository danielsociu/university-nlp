...
model.save_pretrained("model_pretrained_Adam_128_16_god_seed_v3")
torch.save(model.state_dict(), "model_Adam_128_16_clip_god_seed_v3.pt")
...
g = open("adam_sample_128_16_god_seed_v3.csv", "w")
idx = 0
