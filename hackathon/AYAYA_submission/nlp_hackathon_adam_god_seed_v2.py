...
loss_criterion = nn.CrossEntropyLoss(weight=torch.as_tensor(weights, dtype=torch.float).to(device), ignore_index=-100)
...
model.save_pretrained("model_pretrained_Adam_128_16_god_seed_v2")
torch.save(model.state_dict(), "model_Adam_128_16_clip_god_seed_v2.pt")
...
g = open("adam_sample_128_16_god_seed_v2.csv", "w")
idx = 0
